...
const Card = ({ cargandoData, showData, weather, forecast }) => {
                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <img src="https://images.pexels.com/photos/16567828/pexels-photo-16567828/free-photo-of-ligero-ciudad-luces-calle.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start" alt=".." />
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body text-start mt-2">
                                        ...
                                        <h5 className="card-text">Sensación térmica: {(weather.main.temp_max - 273.15).toFixed(1)}°C</h5>
